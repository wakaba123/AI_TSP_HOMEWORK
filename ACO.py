...
class Ant:
    def __init__(self, graph, num):
        ...
        # 规定从第一个城市开始走
        self.tabu = [1]
        self.allowed = [i for i in range(2, 10)]
        self.nowCity = 1
...
class ACO:
    def __init__(self, graph, num):
        ...
        self.num = num
        self.initN = 200
        self.bestTour = [i for i in range(1, 10)]
...
# def TSP(self,graph,num):
#   ACO.startAnt(self,1000)
